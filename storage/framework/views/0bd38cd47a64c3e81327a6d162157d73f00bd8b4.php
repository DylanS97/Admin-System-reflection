                    ...
                    <form>
                        <select name="Company" id="company-select" class="rounded-lg transition-shadow ml-5 companySelect">
                            ...
                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($company->name); ?>" <?php if($com == $company->name): ?> selected <?php endif; ?>><?php echo e($company->name); ?></option>
...
<?php endif; ?><?php /**PATH C:\Users\Dylan\OneDrive\Desktop\Programming\Netmatters\laravel-reflection\resources\views/employees/employees.blade.php ENDPATH**/ ?>